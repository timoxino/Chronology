...
{
    private static final String jarFilePath = System.getProperty("user.home") + "/Development/mvn_repo/" + "by/chronology/agent/agent/0.0.1-SNAPSHOT/"
